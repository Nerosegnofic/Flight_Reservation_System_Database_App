...
namespace Flight_Reservation_System_App
{
    public partial class Form9 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "INSERT INTO Passenger VALUES('" + textBox1.Text + "', '" + textBox2.Text + "')";
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "DELETE FROM Passenger WHERE Flight_ID='" + textBox1.Text + "' OR Passenger_ID = '" + textBox2.Text + "'";
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(textBox1.Text))
                query += "Flight_ID = '" + textBox1.Text + "', ";
            if (!string.IsNullOrEmpty(textBox2.Text))
                query += "Passenger_ID = '" + textBox2.Text + "', ";

            // Remove the trailing comma and space
            query = query.TrimEnd(' ', ',');

            // Add the WHERE clause
            query += " WHERE Flight_ID = '" + textBox1.Text + "' OR Passenger_ID = '" + textBox2.Text + "' ";
